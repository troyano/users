...
public class Constants {
	...
	public static final String MSG_ROLE_CLIENT_DOES_NOT_EXIST = "Role CLIENT does not exist";
	...
	public static final String MSG_INVALID_CREDENTIALS  = "Credentials invalidates";

	public static final String MSG_USER_EMPLOYEE_ALREADY_EXISTS = "Employee already exists";
	public static final String MSG_USER_CLIENT_ALREADY_EXISTS = "Client already exists";
	// Regular Expressions
